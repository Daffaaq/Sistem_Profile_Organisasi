                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nickname_profiles" id="nickname_profiles"
                                                    class="form-control" value="{{ $profile->nickname_profiles }}" required>
                                            </div>
                                            <!-- Name -->
                                            <div class="form-group">
                                                <label for="name_profiles">Name<span style="color: red;">*</span>:</label>
                                                <input type="text" name="name_profiles" id="name_profiles"
                                                    class="form-control" value="{{ $profile->name_profiles }}" required>
                                            </div>
                                            <!-- Address -->
                                            <div class="form-group">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="twitter_url" id="twitter_url"
                                                    class="form-control" value="{{ $profile->twitter_url }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="facebook_url" id="facebook_url"
                                                    class="form-control" value="{{ $profile->facebook_url }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="instagram_url" id="instagram_url"
                                                    class="form-control" value="{{ $profile->instagram_url }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="linkedin_url" id="linkedin_url"
                                                    class="form-control" value="{{ $profile->linkedin_url }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="line_url" id="line_url"
                                                    class="form-control" value="{{ $profile->line_url }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="tiktok_url" id="tiktok_url"
                                                    class="form-control" value="{{ $profile->tiktok_url }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="youtube_url" id="youtube_url"
                                                    class="form-control" value="{{ $profile->youtube_url }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
