...
@section('container')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <a href="{{ url('/admin/Aspiration/create') }}" class="btn btn-success float-right mb-3">
    ...
    <script>
        $(document).ready(function() {
            $('#AspirationTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ url('/admin/Aspiration/data') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#AspirationTable').on('click', '.update-status', function(e) {
                e.preventDefault();
                var id = $(this).data('id');
                var updateUrl = '{{ url('/admin/Aspiration/updateStatus') }}/' + id;
